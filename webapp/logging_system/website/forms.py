...
class AddModelForm(forms.ModelForm):
    ...
    model_type    = forms.ChoiceField(required=True, widget=forms.RadioSelect, choices = {'kmeans': 'K-Means', 'bkmeans': 'Bisecting K-Means', 'rf': 'Random Forest', 'nb': 'Naive Bayes', 'svm': 'Support Vector Machines'})
