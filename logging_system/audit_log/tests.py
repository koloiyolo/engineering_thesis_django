...
class AuditLogTestCase(TestCase):
    ...
    def test_create_audit_log(self):
        ...
        audit_log = AuditLog.objects.create(
            user=self.user, message="Test message for audit log"
        )
    ...
    def test_user_can_be_null(self):
        ...
        audit_log = AuditLog.objects.create(
            user=None, message="Test message with no user"
        )
    ...
    def test_message_max_length(self):
        ...
        long_message = "A" * 256
        audit_log = AuditLog.objects.create(user=self.user, message=long_message)
    ...
    def test_create_audit_log_without_message(self):
        ...
        audit_log = AuditLog.objects.create(user=self.user, message="")
    ...
    def test_auto_now_datetime(self):
        ...
        audit_log = AuditLog.objects.create(
            user=self.user, message="Test message with auto_now"
        )
